 ...
 * });
 */
export function useSeeLikesQuery(
  baseOptions: Apollo.QueryHookOptions<SeeLikesQuery, SeeLikesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SeeLikesQuery, SeeLikesQueryVariables>(
    SeeLikesDocument,
    options,
  );
}
export function useSeeLikesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SeeLikesQuery,
    SeeLikesQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SeeLikesQuery, SeeLikesQueryVariables>(
    SeeLikesDocument,
    options,
  );
}
export type SeeLikesQueryHookResult = ReturnType<typeof useSeeLikesQuery>;
export type SeeLikesLazyQueryHookResult = ReturnType<
  typeof useSeeLikesLazyQuery
>;
export type SeeLikesQueryResult = Apollo.QueryResult<
  SeeLikesQuery,
  SeeLikesQueryVariables
>;
